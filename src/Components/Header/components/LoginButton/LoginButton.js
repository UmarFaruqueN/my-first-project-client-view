...
const LoginButton = () => {
    ...
    const SendOTP = handleSubmit((data) => {
        console.log(data);
        axios
            .post(loginPost, data, { headers: { "Content-Type": "application/json" } })
            .then((response) => {
    ...
    const VerifyOTP = handleSubmit((data) => {
        console.log(data);
        axios
            .post(verifyPost, data, { headers: { "Content-Type": "application/json" } })
            .then((response) => {
        ...
        <div>
            ...
            <Dialog open={open} onClose={Submit}>
                <DialogTitle>
                    ...
                    <img onClick={Submit} src="https://d30y9cdsu7xlg0.cloudfront.net/png/53504-200.png" style={closeImg} />
                </DialogTitle>
